...
function buildFallback() {
  return {
    content: {
      ...
      "workshop.title": "Learn Resin Art with Ruchi",
      "workshop.subtitle": "Join hands-on creative workshops and make your own resin pieces.",
      "workshop.description": "Beginner-friendly resin workshops covering materials, safety, pouring techniques, finishing, and design basics.",
      "workshop.schedule": "Weekend batches available",
      "workshop.location": "Jalandhar Studio",
      "workshop.seats": "Limited seats per batch",
      "workshop.cta": "Book Workshop Seat",
      "menu.workshop.badge": "New",
      "menu.gallery.badge": "",
